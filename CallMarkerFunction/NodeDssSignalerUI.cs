...
public class NodeDssSignalerUI : MonoBehaviour
{
    ...
    public void onStartConnection()
    {
        if(string.IsNullOrEmpty(ipAddress.text))
        {
            ...
            NodeDssSignaler.HttpServerAddress = "http://" + f.Remove(f.Length - 1, 1) + ":3000/";
        }
        else
        {
            NodeDssSignaler.HttpServerAddress = "http://" + ipAddress.text + ":3000/";
        }
        Debug.Log("NodeDssSignaler address: " + NodeDssSignaler.HttpServerAddress);
    }
//     /// <summary>
