...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    public class NodeDSS : Signaler
    {
        ...
        private void Start()
        {
            ...
            PeerConnection.OnInitialized.AddListener(OnInitialized1);
        }
        ...
        private bool receivedOffer = false; 
            ...
            if (!www.isNetworkError && !www.isHttpError)
            {
                ...
                if (msg != null)
                {
                    ...
                    case NodeDssMessage.Type.Offer:
                        ...
                        //once we receive an offer msg, add any ice candidates that we early
                        receivedOffer = true;
        ...
        protected override void Update()
        {
            ...
            if (pcinit) {
                _nativePeer.IceStateChanged += (IceConnectionState newICEState) => {
                    Debug.Log("ICE STATE: " + newICEState);
                    if (receivedOffer && newICEState == IceConnectionState.Disconnected) {
                        Debug.Log("Reset receivedOffer");
                        receivedOffer = false;
                    }
                };
            }
